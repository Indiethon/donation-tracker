...
module.exports = (tracker, database) => {
    ...
    const eventMiddleware = async (req, res, next) => {
        if (mongoose.Types.ObjectId.isValid(req.params.event)) {
            req.query.event = req.params.event;
            next();
            return;
        }
    ...
    app.get('/api/events/:event', eventMiddleware, (req, res) => event.fetchEvent(req, res))
    ...
    app.post('/api/speedruns/startTime/:id', (req, res) => speedrun.setStartTime(req, res));
    app.post('/api/speedruns/finalTime/:id', (req, res) => speedrun.setFinalTime(req, res));
    ...
    app.post('/api/drawPrizes', (req, res) => prize.drawPrizes(req, res))
    app.get('/api/resetPrizes', (req, res) => prize.resetDrawnPrizes(req, res))
    ...
    // Prizes Redemptions
    app.get('/api/prizeRedemptions', (req, res) => prizeRedemption.fetchPrizeRedemption(req, res))
    app.get('/api/prizeRedemptions/:id', (req, res) => prizeRedemption.fetchPrizeRedemption(req, res))
    app.get('/api/prizeRedemptions/event/:event', (req, res) => prizeRedemption.fetchPrizeRedemption(req, res))
    app.post('/api/prizeRedemptions', (req, res) => prizeRedemption.updatePrizeRedemption(req, res))
    app.post('/api/prizeRedemptions/:id', (req, res) => prizeRedemption.updatePrizeRedemption(req, res))
    app.delete('/api/prizeRedemptions/:id', (req, res) => prizeRedemption.deletePrizeRedemption(req, res))
    ...
    // Blurbs
    app.get('/api/blurbs', (req, res) => blurb.fetchBlurb(req, res))
    app.get('/api/blurbs/:id', (req, res) => blurb.fetchBlurb(req, res))
    app.get('/api/blurbs/event/:event', eventMiddleware, (req, res) => blurb.fetchBlurb(req, res))
    app.post('/api/blurbs', (req, res) => blurb.updateBlurb(req, res))
    app.post('/api/blurbs/:id', (req, res) => blurb.updateBlurb(req, res))
    app.delete('/api/blurbs/:id', (req, res) => blurb.deleteBlurb(req, res))
    ...
    // Email Addresses
    app.get('/api/emailAddress', (req, res) => emailAddress.fetchEmailAddress(req, res))
    app.get('/api/emailAddress/:id', (req, res) => emailAddress.fetchEmailAddress(req, res))
    app.post('/api/emailAddress', (req, res) => emailAddress.updateEmailAddress(req, res))
    app.post('/api/emailAddress/:id', (req, res) => emailAddress.updateEmailAddress(req, res))
    app.delete('/api/emailAddress/:id', (req, res) => emailAddress.deleteEmailAddress(req, res))

    // Email Templates
    app.get('/api/emailTemplate', (req, res) => emailTemplate.fetchEmailTemplate(req, res))
    app.get('/api/emailTemplate/:id', (req, res) => emailTemplate.fetchEmailTemplate(req, res))
    app.post('/api/emailTemplate', (req, res) => emailTemplate.updateEmailTemplate(req, res))
    app.post('/api/emailTemplate/:id', (req, res) => emailTemplate.updateEmailTemplate(req, res))
    app.delete('/api/emailTemplate/:id', (req, res) => emailTemplate.deleteEmailTemplate(req, res))

    // Emails
    app.post('/api/sendTestEmails', (req, res) => emails.sendTestEmails(req, res))
    app.post('/api/sendPrizeEmails', (req, res) => emails.sendPrizeEmails(req, res))
    ...
    async function sendMiscDetails(req, res) {
        ...
        if (activeEvent !== undefined && activeEvent !== null) details.activeEvent = true;
