...
module.exports = (tracker, database) => {
    ...
    app.post('/api/events', authMiddleware, (req, res) => event.updateEvent(req, res))
    ...
    app.post('/api/charities', authMiddleware, (req, res) => charity.updateCharity(req, res))
    ...
    // Speedruns
    app.post('/api/speedruns', authMiddleware, (req, res) => speedrun.updateSpeedrun(req, res))
    ...
    // Donations
    app.post('/api/donations', authMiddleware, (req, res) => donation.updateDonation(req, res))
    ...
    // Donors
    app.post('/api/donors', authMiddleware, (req, res) => donor.updateDonor(req, res))
    ...
    // Incentives
    app.post('/api/incentives', authMiddleware, (req, res) => incentive.updateIncentive(req, res))
    ...
    app.post('/api/auditLogs', authMiddleware, (req, res) => auditLog.updateAuditLog(req, res))
