    ...
    constructor(event) {
        ...
        this.events = {
            async getPreMain() {
                ...
                <div class="successText">Your donation was successful!</div>
    ...
    .footer {
        ...
        font-size: 16px;
            ...
            async runFunction(details) {
                document.querySelector('.successMessage').innerHTML = details.donationSuccessMessage;
                setTimeout(() =>{
