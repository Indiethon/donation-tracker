...
async function loadPage() {
    ...
    if (window.location.pathname.includes('/donate')) {
        if (!details.activeEvent) window.location = '/home'
    ...
    else if (!window.location.pathname.includes('?event=') && details.activeEvent) {
        document.querySelector('.eventDropdownText').innerHTML = details.activeEvent.name;
        short = details.activeEvent.short;
    }
